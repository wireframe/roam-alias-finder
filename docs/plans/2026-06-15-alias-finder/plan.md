...
- [ ] Task 1.1: Initialize git + npm project
...
- [ ] Task 1.2: Add esbuild build script
...
- [ ] Task 1.3: Add Depot CI build entry + vitest config + .gitignore
...
- [ ] Task 1.4: Copy teardown registry
...
- [ ] Task 1.5: Page context module (current page title + UID + nav observer)
...
- [ ] Task 1.6: Extension entry with no-op bottom button (TDD: write a render-helper test first)
...
- [ ] Task 1.7: Wire onload/onunload to inject button at page bottom
...
- [ ] Task 1.8: Minimal extension.css + Depot metadata files
...
- [ ] Commit Phase 1 ("Phase 1: extension skeleton + bottom-of-page button")

## Phase 2: Matching engine (pure, unit-tested)

- [ ] Task 2.1: Alias parser test (TDD red)
...
- [ ] Task 2.2: Implement alias parser (TDD green)
...
- [ ] Task 2.3: Text matcher test — core whole-word + case-insensitive (TDD red)
...
- [ ] Task 2.4: Implement text matcher core (TDD green)
...
- [ ] Task 2.5: Text matcher test — guard rules (TDD red)
...
- [ ] Task 2.6: Implement guard rules (TDD green)
...
- [ ] Commit Phase 2 ("Phase 2: pure alias-parsing + guarded matching engine")

## Phase 3: Graph data layer

- [ ] Task 3.1: roam-data test with mocked roamAlphaAPI (TDD red)
...
- [ ] Task 3.2: Implement alias-seed collection (TDD green)
...
- [ ] Task 3.3: Implement graph-wide candidate scan (TDD green)
...
- [ ] Task 3.4: Manual smoke check on a real page
...
- [ ] Commit Phase 3 ("Phase 3: graph data layer — alias seeds + unlinked candidate scan")

## Phase 4: Results UI + link action

- [ ] Task 4.1: Link-action test (TDD red)
...
- [ ] Task 4.2: Implement link action (TDD green)
...
- [ ] Task 4.3: Results panel render test (TDD red)
...
- [ ] Task 4.4: Implement results panel (TDD green)
...
- [ ] Task 4.5: Wire button → find → render → link, with row removal
...
- [ ] Commit Phase 4 ("Phase 4: results UI + link action — end-to-end alias finder")
